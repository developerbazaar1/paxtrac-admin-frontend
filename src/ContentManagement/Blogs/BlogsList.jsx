...
const BlogsList = () => {
  ...
  const [allData, setAllData] = useState(demoBlogs);
  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (res.isConfirmed) {
        setAllData((prev) => prev.filter((b) => b.id !== id));
        ...
        cellRenderer: (params) => (
          <div className="d-flex gap-2">
            <button
              ...
              onClick={() =>
                navigate("/content-management/blogs/view", {
                  state: params.data,
                })
              }
            >
    ...
    <div className="custom-card bg-white p-3">
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <button
          ...
          onClick={() => navigate("/content-management/blogs/add")}
        >
          Add Blog
        </button>
      </div>
